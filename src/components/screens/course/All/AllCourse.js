...
import listData from './AllCourseContainer'
import ListAllCourse from './ListAllCourse'

export default class AllCourse extends React.PureComponent {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                {/* <Text>Hello</Text> */}
                <Header headerName='AllCourse' isBack={true} navigation={navigation} />
                <FlatList
                    data={listData}
                    renderItem={({ item }) =>
                        // this.renderRowThree(item)
                        // console.log(item)
                        < ListAllCourse
                            item={item}
